/**
 * Cálculo de distância em linha reta (Haversine) e formatadores compartilhados
 * entre web e mobile.
 *
 * Distância é em linha reta — não é a rota real por estradas. Suficiente como
 * referência ("perto" / "longe"). Se um dia precisarmos de rota real, troca
 * por uma chamada à Mapbox Directions API no servidor.
 */
